...
class Phi3FlashAttention2(nn.Module):
    ...
    def forward(
        ...
        query_states= apply_rotary(query_states, cos, sin, 0, cu_seqlens_q, max_seqlen_in_batch_q)
        key_states = apply_rotary(key_states, cos, sin, 0, cu_seqlens_k, max_seqlen_in_batch_k)
        ...
        value_states = index_first_axis(
            value_states.reshape(batch_size * kv_seq_len, num_key_value_heads, head_dim), indices_k
        )
